...
def initialize_model(model_name, keep_frozen=False, use_pretrained=True):
    """
    ...
    if model_name == "resnet18":
        ...
        model.classifier[3] = nn.Linear(num_features, 256)
        num_features = 256
        model.classifier[6] = nn.Sequential()
        input_image_size = 224
        resize_image_size = 256
    ...
    return model, resize_image_size, input_image_size, num_features